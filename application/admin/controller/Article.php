...
//        $nav = Db::name('category')->where(array('pid'=>'0','status'=>'normal'))->order('weigh desc,id desc')->select();
...
//        }
        ...
        $casenav=Db::name('category')->where(array('pid'=>'2'))->order('rank desc')->select();
        $this->view->assign("casenav", $casenav);

        $this->view->assign("parentList", $categorydata);
        $this->view->assign("caserecommendList", $this->model->getcaserecommenList());//案例推荐
