define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'categoryusert/index',
                    add_url: 'categoryusert/add',
                    edit_url: 'categoryusert/edit',
                    del_url: 'categoryusert/del',
                    import_url: 'categoryusert/import',
                    multi_url: 'categoryusert/multi',
                    dragsort_url: '',
                    table: 'categoryusert',
                }
            });
