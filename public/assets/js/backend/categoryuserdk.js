define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'categoryuserdk/index',
                    add_url: '',
                    edit_url: 'categoryuserdk/edit',
                    del_url: 'categoryuserdk/del',
                    import_url: 'categoryuserdk/import',
                    multi_url: 'categoryuserdk/multi',
                    dragsort_url: '',
                    table: 'categoryuserdk',
                }
            });
            ...
            var tableOptions = {
                ...
                columns: [
                    [
                        ...
                        {field: 'daikuanOrderNumber', title: __('贷款客户'), align: 'left'},
                        {field: 'all_daikuanOrderNumber', title: __('全年新增客户'), align: 'left'},
                        {field: 'amount', title: __('季度贷款金额'), align: 'left'},
                        {field: 'all_amount', title: __('全年贷款金额'), align: 'left'},
                        // {
                        //     field: 'id',
