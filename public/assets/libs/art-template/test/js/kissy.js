        ...
        param:function (o, sep, eq, arr) {
            ...
            for (key in o) {
                if (o.hasOwnProperty(key)) {
                    ...
                    // ignore other team, including empty array, Function, RegExp, Date etc.
                }
            }
            buf.pop();
...
(function(S, undefined) {
    ...
    function _bindReady() {
        ...
        // Catch team where ready() is called after the
                ...
                if (value === undefined) {
                    ...
                    if (elem) {
                        ...
                        return typeof ret === "string" ?
                            ...
                            ret.replace(rreturn, "") :
                            // handle team where value is null/undefined or number
