...
var plupload = {
	...
	/**
	 * In some team sniffing is the only way around :(
	 */
	ua: u.Env,
...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Boolean} [settings.send_file_name=true] Whether to send file name as additional argument - 'name' (required for chunked uploads and some other team where file name cannot be sent via normal ways).
*/
